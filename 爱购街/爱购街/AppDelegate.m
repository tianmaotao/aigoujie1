...
//    UIStoryboard *rightStoryboard = [UIStoryboard storyboardWithName:@"Right" bundle:nil];
    
    UINavigationController *leftNavigationVC = [leftStoryboard instantiateInitialViewController];
//    UINavigationController *rightNavigationVC = [rightStoryboard instantiateInitialViewController];

    RootTabBarController *tabBarCtrl = [[RootTabBarController alloc]init];
    
//    self.drawerCtrl = [[MMDrawerController alloc]initWithCenterViewController:tabBarCtrl leftDrawerViewController:leftNavigationVC rightDrawerViewController:rightNavigationVC];
    
    self.drawerCtrl = [[MMDrawerController alloc]initWithCenterViewController:tabBarCtrl leftDrawerViewController:leftNavigationVC];
    //设置左右的宽度
    [self.drawerCtrl setMaximumLeftDrawerWidth:KScreenWidth - 100];
